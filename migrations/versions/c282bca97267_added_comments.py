...
Revision ID: c282bca97267
Revises: 7c2408b778b2
Create Date: 2020-07-30 23:07:02.903232
...
revision = 'c282bca97267'
down_revision = '7c2408b778b2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('blog_post', 'author_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('blog_post', 'slug',
    ...
    # op.drop_constraint('blog_post_slug_key', 'blog_post', type_='unique')
    # op.drop_index('blog_post_title_adf2f203_like', table_name='blog_post')
    # op.drop_constraint('blog_post_author_id_dd7a8485_fk_auth_user_id', 'blog_post', type_='foreignkey')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_foreign_key('blog_post_author_id_dd7a8485_fk_auth_user_id', 'blog_post', 'auth_user', ['author_id'], ['id'], initially='DEFERRED', deferrable=True)
    op.create_index('blog_post_title_adf2f203_like', 'blog_post', ['title'], unique=False)
    op.create_unique_constraint('blog_post_slug_key', 'blog_post', ['slug'])
